...
public class NonBlockingHotDAOFunctionalTest extends FunctionalTest {
    ...
    private Logger logger = LoggerFactory.getLogger(NonBlockingHotDAOFunctionalTest.class);
    ...
    public void returnsContent() throws URISyntaxException {
        Response response = getResponseFromHandler("dao-nonblocking-hot");
    ...
    public void handlerIsNotBlocking() throws InterruptedException {
        List<Response> responses = new ConcurrentExecutor(() -> getResponseFromHandler("dao-nonblocking-hot"), NUMBER_OF_CALLS).executeRequestsInParallel();
